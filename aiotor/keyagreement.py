...
from aiotor.crypto import TOR_DIGEST_LEN, kdf_tor
from aiotor.property import async_cached_property
from aiotor.crypto_common import (
    hmac,
    dh_public,
    dh_shared,
    dh_private,
...
class NtorKeyAgreement(KeyAgreement):
    ...
    @async_cached_property
    async def _B(self):  # noqa: N802
        return curve25519_public_from_bytes((await self._onion_router.descriptor).ntor_key)
    ...
    async def handshake(self):
        ...
        handshake += curve25519_to_bytes(await self._B)
