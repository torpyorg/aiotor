...
from aiotor.documents.basics import TorDocumentObject, TorDocument
from aiotor.documents.items import ItemType, ItemParsers, Item, ItemObject, ItemDate, ItemInt, ItemEnum, ItemMulti
from aiotor.crypto_common import sha3_256, b64decode
...
class Router:
    ...
    async def descriptor(self):
        ...
        return await self._consensus.get_descriptor(self._fingerprint)
